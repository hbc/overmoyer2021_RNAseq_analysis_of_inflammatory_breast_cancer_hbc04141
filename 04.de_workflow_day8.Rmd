...
genes_to_show <- c("HLA-DMB", "CCR5", "HLA-E", "LAG3", "ITGB2",
                  "FCGR3A", "CD8B", "HLA-DPA1", "CD8A", "CD163",
                  "LY86", "HLA-A", "HLA-DPB1", "CCL5", "LILRB4",
                  "CD38", "HLA-B", "CD74", "CD274", "FCGR2B")

resResponse_tb_vis$symbol <- ifelse(resResponse_tb_vis$symbol %in% genes_to_show, 
                                    resResponse_tb_vis$symbol, NA)
...
fig4b <- ggplot(resResponse_tb_vis,
  ...
  geom_text_repel(aes(label = symbol), size = 5)
